...
def test_parser_e2e(glob_mock):
    ...
    with mock.patch('rip_api.ingest.gesetze_im_internet.open', mock_open):
        law = LawXmlParser('mock/xml/dir/path', 'mylaw').parse()

    assert law.type_ == 'law'
    assert law.id == 'BJNR055429995'
    ...
    item = law.contents[0]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNE000600305'
    ...
    item = law.contents[1]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNG000100305'
    ...
    item = law.contents[2]
    assert item.type_ == 'headingArticle'
    assert item.id == 'BJNR055429995BJNG000200305'
    ...
    item = law.contents[3]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNE000700305'
    assert item.name == '§ 1'
    ...
    item = law.contents[4]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNE000801310'
    assert item.name == '§ 2'
    ...
    item = law.contents[5]
    assert item.type_ == 'heading'
    assert item.id == 'BJNR055429995BJNG000300305'
    ...
    item = law.contents[6]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNE002801311'
    assert item.name == '§ 1'
    assert item.title == None
    ...
    item = law.contents[7]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNE002900305'
    assert item.name == '§ 2'
    assert item.title == None
    ...
    item = law.contents[8]
    assert item.type_ == 'article'
    assert item.id == 'BJNR055429995BJNG000400305'
